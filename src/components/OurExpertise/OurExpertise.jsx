...
import { MessageSquare, Search, Code, PenTool, Palette, Mail } from 'lucide-react';

const expertiseItems = [
  {
    title: "Social Media\nManagement",
    desc: "We operate from within the problem, then govern execution to measurable outcomes.",
    icon: <MessageSquare size={32} strokeWidth={1.5} /> // Social media icon
  },
  {
    title: "SEO Optimization",
    desc: "We operate from within the problem, then govern execution to measurable outcomes.",
    icon: <Search size={32} strokeWidth={1.5} /> // SEO/search icon
  },
  {
    title: "Website\nDevelopment",
    desc: "We operate from within the problem, then govern execution to measurable outcomes.",
    icon: <Code size={32} strokeWidth={1.5} /> // Coding/development icon
  },
  {
    title: "Content Marketing",
    desc: "We operate from within the problem, then govern execution to measurable outcomes.",
    icon: <PenTool size={32} strokeWidth={1.5} /> // Writing/creation icon
  },
  {
    title: "Branding Strategy",
    desc: "We operate from within the problem, then govern execution to measurable outcomes.",
    icon: <Palette size={32} strokeWidth={1.5} /> // Design/branding icon
  },
  {
    title: "Email Marketing",
    desc: "We operate from within the problem, then govern execution to measurable outcomes.",
    icon: <Mail size={32} strokeWidth={1.5} /> // Email icon
  },
];
